                            ...
                            <div class="card-body px-0">
                                <h2 class="card-title">
                                    <a class="text-white opacity-75-onHover"
                                        href="{{ url('/singlepost/' . $post->id) }}">{{ ucfirst($post->title) }}</a>
                                </h2>
                                <ul class="post-meta mt-3">
                                    ...
                                    <li class="d-inline-block">
                                        ...
                                        <a class="ml-1"
                                            href="#">{{ $post->user ? $post->user->name : 'Gust User' }}</a>
                                    </li>
                                </ul>
            ...
            <div class="col-lg-4 col-md-5">
                ...
                <div class="widget">
                    ...
                    <div class="card post-item bg-transparent border-0 mb-5">
                        <a href="post-details.html">
                            <img class="card-img-top rounded-0"
                                src="{{ asset('/frontend/assets/') }}/images/post/post-sm/01.png" alt="">
                        </a>
                        <div class="card-body px-0">
                            <h2 class="card-title">
                    ...
                    <div class="card post-item bg-transparent border-0 mb-5">
                        <a href="post-details.html">
                            <img class="card-img-top rounded-0"
                                src="{{ asset('/frontend/assets/') }}/images/post/post-sm/02.png" alt="">
                        </a>
                        <div class="card-body px-0">
                            <h2 class="card-title">
                                <a class="text-white opacity-75-onHover" href="post-details.html">Excepteur
